...
export async function updateAgentFiles(body) {
  ...
  console.log(`📊 Datos recibidos: ${Hoteles.length} hoteles, ${Servicios.length} servicios, ${Paquetes.length} paquetes${bodegasInfo}${proveedoresInfo}${productsInformationInfo}${descripcionesInfo}`);
